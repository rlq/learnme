...
/**
 * Author lqren on 17/2/27.
 */
public class SpanTextView0227 extends LinearLayout {

    public SpanTextView0227(Context context) {
        super(context);
        init();
    }
...
*/
        ...
        word2.setSpan(new StyleSpan(Typeface.NORMAL), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
